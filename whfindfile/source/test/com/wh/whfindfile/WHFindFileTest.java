...
public class WHFindFileTest {
    ...
    public void testMainMissingParams() throws Exception {
        String[] args = {"-p", "pattern"};
        try {
            WHFindFile.main(args);
     ...
     */
    @Test(expected = BrokenCode.class)
    public void testMainMissingF() throws Exception {
     ...
     */
    @Test(expected = BrokenCode.class)
    public void testMainMissingP() throws Exception {
        String path = this.getClass().getClassLoader().getResource("").getPath();
        path = path + "../../test/resources/searchtest/empty";
     ...
     */
    @Test(expected = BrokenCode.class)
    public void testMainInvalidDirectory() throws Exception {
        String path = this.getClass().getClassLoader().getResource("").getPath();
     ...
     */
    @Test(expected = BrokenCode.class)
    public void testMainEmptyDirectory() throws Exception {
        String path = this.getClass().getClassLoader().getResource("").getPath();
        path = path + "../../test/resources/searchtest/empty";
        String[] args = {"-p", "mypackage", "-f", "data.txt", path};
        try {
